...
/usr/local/go/bin/go build -compiler gccgo -o /root/go/bin/vault_binary -v
/usr/local/go/bin/go build -compiler gccgo -o /root/go/bin/consul-template -v 
/usr/local/go/bin/go build -compiler gccgo -o /root/go/bin/vault_initializer -v  
